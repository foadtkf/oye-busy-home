...
const AssuredPeace = () => {
  ...
  <div class="hero-content flex-col lg:flex-row">
    ...
    <div>
      ...
      <p class="py-6">Only authorized service express and genuine spare parts and equipments.</p>
...
<div class="hero">
  <div class="hero-content flex-col lg:flex-row">
    ...
    <div>
      ...
      <p class="py-6">Pay online for Safe & Secure Payment. Many benifits and offers available with online payment.</p>
    </div>
  </div>
</div>
      </div>
